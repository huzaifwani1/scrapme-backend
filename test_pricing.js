...
console.log('64GB should be ₹450:', frontendPrices['64GB'] === 450 ? '✓ PASS' : '✗ FAIL');
console.log('256GB should be ₹1200:', frontendPrices['256GB'] === 1200 ? '✓ PASS' : '✗ FAIL');
console.log('32GB should be ₹250:', frontendPrices['32GB'] === 250 ? '✓ PASS' : '✗ FAIL');
console.log('128GB should be ₹600:', frontendPrices['128GB'] === 600 ? '✓ PASS' : '✗ FAIL');

console.log('\nBackend Pricing Test:');
const backendPrices = { '32GB': 250, '64GB': 450, '128GB': 600, '256GB': 1200, '512GB': 1500, '1TB': 2400 };
console.log('64GB should be ₹450:', backendPrices['64GB'] === 450 ? '✓ PASS' : '✗ FAIL');
console.log('256GB should be ₹1200:', backendPrices['256GB'] === 1200 ? '✓ PASS' : '✗ FAIL');

console.log('\nSummary of changes:');
console.log('- 32GB: ₹400 → ₹250 (decrease of ₹150)');
console.log('- 64GB: ₹700 → ₹450 (decrease of ₹250)');
console.log('- 128GB: ₹1000 → ₹600 (decrease of ₹400)');
...
const requestedPrices = { '32GB': 250, '64GB': 450, '128GB': 600, '256GB': 1200, '512GB': 1500, '1TB': 2400 };
let allMatch = true;
